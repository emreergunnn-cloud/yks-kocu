...
import { BookOpen, Mail, Lock, User, ArrowRight, Eye, EyeOff, RotateCcw } from "lucide-react";
...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (msg.includes("wrong-password") || msg.includes("invalid-credential")) setError("E-posta veya şifre hatalı.");
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {successMsg && (
              <p className="text-xs text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 p-3 rounded-xl">
                {successMsg}
              </p>
            )}
